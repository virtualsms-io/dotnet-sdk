...
/// </summary>
public class NoNumbersException : ServerErrorException
{
    public NoNumbersException(int statusCode, bool isMutating, string message) : base(statusCode, isMutating, message) { }
}
